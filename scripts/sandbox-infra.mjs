...
r.ControllerRole=ready('AWS::IAM::Role',{AssumeRolePolicyDocument:assume('lambda.amazonaws.com'),Policies:[policy('SandboxOnly',[
  {...allow(['dynamodb:GetItem','dynamodb:UpdateItem','dynamodb:PutItem','dynamodb:ConditionCheckItem'],att('RateTable')),Condition:{'ForAllValues:StringLike':{'dynamodb:LeadingKeys':['sandbox:*']}}},
